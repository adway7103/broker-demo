...
export default function EditPropertyPage() {
  ...
  const updateFormData = (field: keyof PropertyFormData, value: string | string[] | boolean) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(error.error || 'Error updating property');
      }
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Update property listing details</p>
          </div>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={formData.isRented ? "RENTED" : "AVAILABLE"}
                    onChange={(e) => updateFormData("isRented", e.target.value === "RENTED")}
                    className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2"
                  >
